...
async def _(event):
    if ispay2[0] == "yes":
        ...
        async def _(event):
            if ispay2[0] == "yes":
                if "on" in isclaim:
                    await event.edit(f"الفحص وصل > ({trys})")
                elif "off" in isclaim:
        ...
        for i in range(int(msg[0])):
            ...
            if "Available" in isav:
                ...
                try:
                    ...
                    await event.client.send_file(event.chat_id, "https://t.me/R_M_T/36", caption=f'''
⌯ Source Max ! 🐊
⤷ User : @{username} 
⤷ Clicks : {trys} 
⤷ Type : #{choice}
...
''')
        ...
        isclaim.append("off")
        trys = ""
        await event.client.send_message("@P8_PPBOT", "Done hunt No.1 🔔")
